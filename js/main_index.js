(function(){ 
	...
	*/
	...
	// 	let ant = document.querySelector('.f-ant__slider'),
	// 		sig = document.querySelector('.f-sig__slider'),
	// 		img = document.getElementById('img__slider');

	// 	let src_imgs = ['recursos/nota-index.jpg', 'recursos/nota2-index.jpg', 'recursos/logo.png'];
		
	// 	let n=0;
		
 //            //establecer img del slider...
